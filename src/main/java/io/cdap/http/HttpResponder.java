...
public interface HttpResponder {
    ...
    /**
     * Sends json response back to the client. This is a convenient method to send json encoded string with content type
     * automatically set to {@code application/json}.
     *
    ...
    /**
     * Send a response containing raw bytes. Default content type is "application/octet-stream", but can be overridden
    ...
    /**
     * Sends a response containing raw bytes. Default content type is "application/octet-stream", but can be overridden
     * by the headers parameter.
     *
     * @param status status of the Http response
    ...
    /**
     * Respond to the client saying the response will be in chunks. The response body can be sent in chunks using the
     * {@link ChunkResponder} returned.
     *
    ...
    /**
     * Send response back to client. Default content type is "application/octet-stream", but can be overridden by the
     * headers parameter.
     *
     * @param status Status of the response.
    ...
    /**
     * Sends response back to client. The response body is produced by the given {@link BodyProducer}. This method will
     * return immediate after it is called. Invocation of methods on the given {@link BodyProducer} will be triggered
     * from another thread. Default content type is "application/octet-stream", but can be overridden by the headers
     * parameter.
     *
     * @param status Status of the response.

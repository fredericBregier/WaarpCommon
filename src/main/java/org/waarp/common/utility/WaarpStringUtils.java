...
public class WaarpStringUtils {
   ...
   * if before = null as date<br> if
   * before != null and before < date, as date<br> if before != null and before
   * >= date, as before end of day
   * (23:59:59:9999)
   *
   * @param date
   * @param before
   ...
   * @param replace
   */
  public final static void replaceAll(StringBuilder builder, String find,
                                      String replace) {
   ...
   */
  public final static boolean replace(StringBuilder builder, String find,
                                      String replace) {
    if (find == null) {
      return false;
    }

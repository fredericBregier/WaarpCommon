 ...
 * counter value - process id - fragment of
 * MAC address and Timestamp. see https://github.com/groupon/locality-uuid.java
 * <br>
 * <br>
...
public final class UUID implements Comparable<UUID> {
   ...
   *
   * @param on128bits True for 128 bits limitation (16 Bytes instead of 20
   *     Bytes)
   */
   ...
   *
   * @param mac the MAC address in byte format (up to the 6 first bytes will
   *     be used)
   */
  ...
  private static byte[] defaultMachineId() {
    ...
    Map<NetworkInterface, InetAddress> ifaces =
  ...
  /**
   * @return positive - current is better, 0 - cannot tell, negative - candidate
   *     is better
   */
   ...
   * 0, from the active MAC address when

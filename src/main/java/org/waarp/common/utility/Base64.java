...
public final class Base64
{
     ...
     * @param options
     *            Specified options
     * @return The Base64-encoded data as an array of bytes
     * @see Base64#GZIP
     * @see Base64#DO_BREAK_LINES
     * @throws IOException
     *             if there is an error
    ...
    public static void decodeToFile(String dataToDecode, String filename)
        ...
        try {
            bos = new Base64OutputStream(
                    new FileOutputStream(filename), DECODE);
    ...
    /**
     * A {@link Base64InputStream} will read data from another <tt>java.io.InputStream</tt>, given in the constructor,
    ...
    /**
     * A {@link Base64OutputStream} will write data to another <tt>java.io.OutputStream</tt>, given in the constructor,
     * and encode/decode to/from Base64 notation on the fly.
     *
     * @see Base64
     * @since 1.3

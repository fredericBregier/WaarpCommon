 ...
 * <li>v2.3.5 - Fixed bug in {@link #encodeFromFile} where estimated buffer size was wrong for files of size 31, 34,
 * and
 * 37 bytes.
 * </li>
 ...
 * streams. Also added experimental support for specifying a class loader when using the {@link
 ...
 * need to embed base64 data in an otherwise "normal" stream (like an XML file).</li>
...
public class Base64 {
     ...
     * enough to accomodate <var>srcOffset</var> + 3 for the <var>source</var> array or <var>destOffset</var> + 4 for
     * the
     ...
     * java.io.IOException.
     * <b>This is new to v2.3!</b> In earlier versions, it just returned a null value, but in retrospect that's a
     * pretty

 ...
 * methods that have a {@link WaarpLogLevel}
 * parameter by default to call specific logger methods such as {@link
 * #info(String)} or {@link #isInfoEnabled()}.
 */
public abstract class AbstractWaarpLogger implements WaarpLogger, Serializable {
  ...
  private static final String getMethodAndLine(final StackTraceElement elt) {
    final StringBuilder builder = new StringBuilder(elt.getClassName())
        ...
        .append(elt.getFileName()).append(':').append(elt.getLineNumber())
        .append(") : ");

...
public interface FileInterface {
  ...
  /**
   * Ask to store the current FileInterface. This command returns quickly since
   * it does not store really. It prepares
   * the object.
   *
   ...
   * since it does not retrieve really. It
   * prepares the object.
   *
   * @return True if everything is ready
   *
   ...
   * is to be called at the beginning of

...
public final class WaarpSslUtility {
     ...
     */
    public static final ChannelFutureListener SSLCLOSE = new ChannelFutureListener() {
    ...
    public static Channel waitforChannelReady(ChannelFuture future) {
        ...
        WaarpNettyUtil.awaitDoneOrInterrupted(future);
        if (!future.isSuccess()) {
                    ...
                    future.addListener(new GenericFutureListener() {
                        ...
                        public void operationComplete(Future future) throws Exception {
                            ...
                            if (cht.channel().isActive()) {
                                cht.close().addListener(new GenericFutureListener<Future<? super Void>>() {
                                    @Override

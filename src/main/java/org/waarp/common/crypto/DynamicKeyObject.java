...
/**
 * This class handles methods to encrypt and unencrypt messages with any available algorithms in the JVM.<br>
 ...
 * As DynamicKey(56, "DES", "DES/ECB/PKCS5Padding", "des") for DES<br> or through Enum class INSTANCES (minimal
 * supported size) or INSTANCESMAX (maximal supported size) as DynamicKey(INSTANCESMAX.AES,"aes")</li>
 * <li>Create a key:
 * <ul>
...
public class DynamicKeyObject extends KeyObject {
    ...
    /**
     * The extension for the file to use when saving the key (note that an extra file as extension.inf will be also

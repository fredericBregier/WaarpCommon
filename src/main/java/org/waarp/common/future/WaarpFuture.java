...
/**
 * Ftp Future operation<br> Completely inspired from the excellent ChannelFuture
 * of Netty, but without any channel
 * inside.
 *
...
public class WaarpFuture {
  ...
  /**
   * Waits for this future to be completed within the specified time limit
   * without interruption. This method catches
   ...
   *     success. Otherwise {@code false} because
   ...
   *
   * @return {@code true} if and only if successfully marked this future as a
   *     failure. Otherwise {@code false} because
   *     this future is already marked as either a success or a failure.
   */
   ...
   *
   * @return {@code true} if and only if the operation has been canceled. {@code
   *     false} if the operation can't be

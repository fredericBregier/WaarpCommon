...
public enum ReplyCode {
   ...
   * the particular implementation), it must
   * read: MARK yyyy (mmmm Where yyyy is User-process data stream marker, and
   * mmmm server's equivalent marker (note
  ...
  /**
   * CR LF<br> A User Telnet MUST be able to send any of the forms: CR LF, CR
   * NUL, and LF. A User Telnet on an ASCII
   * host SHOULD have a user-controllable mode to send either CR LF or CR NUL
   * when the user presses the "end-of-line"

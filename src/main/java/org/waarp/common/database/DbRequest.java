...
public class DbRequest {
   ...
   * update/insert/delete. The previous
  ...
  /**
   * Execute a UPDATE/INSERT/DELETE statement and returns the number of row. The
   * previous statement and resultSet are
   * closed.
   *
   * @param query
   *
   ...
   *
   * @return the long Id or DbConstant.ILLEGALVALUE (Long.MIN_VALUE) if an error
   *     occurs.
   *

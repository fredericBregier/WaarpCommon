 ...
 * <br>
 * <p>
 * If the connection is in autocommit, this abstract should not be used.<br> If
 * the connection is not in autocommit, one
 * could use this implementation to implicitly commit when needed automatically
 * as should do an autocommit connection.
 *

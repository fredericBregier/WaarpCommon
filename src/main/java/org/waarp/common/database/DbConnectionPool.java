 ...
 * @author Frederic Bregier <br> Add TimerTask support to close after some
 *     "delay" any still connected sessions
 */
public class DbConnectionPool {
   ...
   *
   * @param dataSource the data source for the connections.
   * @param maxConnections the maximum number of connections. 0 means no
   *     limit
   ...
   * @param dataSource the data source for the connections.
   * @param timer
   * @param delay in ms period of time to check existing connections and
   ...
   * <code>maxConnections</code> connections are already in use,
   * the method waits until a connection becomes available or
   * <code>timeout</code> seconds elapsed. When the
   * application is finished using the connection, it must close it in order to
   ...
   * <code>Connection.close()</code> has not yet
   * been called.
   *

...
public class Base64Test {
    ...
    @Test
    public void testEncodeBytesByteArray() throws IOException, ClassNotFoundException {
        ...
        src2 = Base64.encodeBytesToBytes(s.getBytes(), 0, s.getBytes().length, Base64.GZIP);
        ...
        assertEquals("Should be equals", serializableObject.value, ((SerializableObject) obj).value);

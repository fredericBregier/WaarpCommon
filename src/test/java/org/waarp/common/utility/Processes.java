...
public class Processes {
  ...
  public static int getPidOfRunnerCommandLinux(String filterByRunner,
    ...
    List<String> args = Arrays
        .asList(("ps -C " + filterByRunner + " -o pid,args=").split(" +"));
    // Example output:
  ...
  public static int executeJvm(Project project, File homeDir, Class<?> zclass,
    ...
    try {
      ...
      System.err.println(
          zclass.getName() + ' ' + builder.toString() + " return code: " + ret +
          " pid: " + pid);
    } catch (final BuildException e) {
      System.err.println("Error While java task");
      e.printStackTrace();
    }
    return pid;
  }
